...
void opcontrol() {
	...
	while (true) {
		...
		int Intakeup = master.get_digital(DIGITAL_L1);
		int Intakedown = master.get_digital(DIGITAL_R1);

		int YButton = master.get_digital(DIGITAL_Y);
		...
		int R2Button = master.get_digital(DIGITAL_R2);

		TickLB(L1Button, R2Button, LBup, LBdown,Xbtn);
